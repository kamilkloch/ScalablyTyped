...
trait jqXHR[TResolve] extends js.Object {
  ...
  def always(
    alwaysCallback: TypeOrArray[
      jqueryLib.JQueryNs.DeferredNs.CallbackBase[
        ...
        jqXHR[TResolve] | java.lang.String, 
        scala.Nothing
      ]
    ],
  ...
  ```
    */
  @JSName("catch")
  def catch_ARFAJFANFBRFBJFBNFCRFCJFCNFRRFRJFRNFPromiseBase[ARF, AJF, ANF, BRF, BJF, BNF, CRF, CJF, CNF, RRF, RJF, RNF](): PromiseBase[ARF, AJF, ANF, BRF, BJF, BNF, CRF, CJF, CNF, RRF, RJF, RNF] = js.native
  /**
  ...
  def done(
    doneCallback: TypeOrArray[
      jqueryLib.JQueryNs.DeferredNs.CallbackBase[TResolve, jqueryLib.JQueryNs.AjaxNs.SuccessTextStatus, jqXHR[TResolve], scala.Nothing]
    ],
  ...
  ```
    */
  @JSName("then")
  def then_ARPAJPANPBRPBJPBNPCRPCJPCNPRRPRJPRNPPromiseBase[ARP, AJP, ANP, BRP, BJP, BNP, CRP, CJP, CNP, RRP, RJP, RNP](): PromiseBase[ARP, AJP, ANP, BRP, BJP, BNP, CRP, CJP, CNP, RRP, RJP, RNP] = js.native
  /**
    * Attaches callbacks for the resolution and/or rejection of the Promise.
    * @param onfulfilled The callback to execute when the Promise is resolved.
    * @param onrejected The callback to execute when the Promise is rejected.
  ...
  @JSName("then")
  def then_TResult1TResult2Thenable[TResult1, TResult2](onfulfilled: js.Function1[/* value */ TResolve, TResult1 | js.Thenable[TResult1]]): js.Thenable[TResult1 | TResult2] = js.native
  @JSName("then")
