...
trait JQueryXHR extends js.Object {
  ...
  var getAllResponseHeaders: js.Any = js.native
  var getResponseHeader: js.Any = js.native
  var overrideMimeType: js.Any = js.native
  ...
  var responseXML: js.UndefOr[stdLib.Document | scala.Null] = js.native
  var setRequestHeader: js.Any = js.native
  ...
  ```
    */
  def always(
    alwaysCallback: jqueryLib.JQueryNs.TypeOrArray[
      jqueryLib.JQueryNs.DeferredNs.CallbackBase[
        _ | jqueryLib.JQueryNs.jqXHR[_], 
        jqueryLib.JQueryNs.AjaxNs.SuccessTextStatus | jqueryLib.JQueryNs.AjaxNs.ErrorTextStatus, 
        jqueryLib.JQueryNs.jqXHR[_] | java.lang.String, 
        scala.Nothing
      ]
    ],
    alwaysCallbacks: (jqueryLib.JQueryNs.TypeOrArray[
      jqueryLib.JQueryNs.DeferredNs.CallbackBase[
        _ | jqueryLib.JQueryNs.jqXHR[_], 
        jqueryLib.JQueryNs.AjaxNs.SuccessTextStatus | jqueryLib.JQueryNs.AjaxNs.ErrorTextStatus, 
        jqueryLib.JQueryNs.jqXHR[_] | java.lang.String, 
  ...
  /**
    ...
    */
  def `catch`[TResult](): jqueryLib.JQueryNs._Promise[_ | TResult] = js.native
  def `catch`[TResult](onrejected: js.Function1[/* reason */ js.Any, TResult | js.Thenable[TResult]]): jqueryLib.JQueryNs._Promise[_ | TResult] = js.native
  def `catch`[ARF, AJF, ANF, BRF, BJF, BNF, CRF, CJF, CNF, RRF, RJF, RNF](
    failFilter: js.Function4[
      /* t */ jqueryLib.JQueryNs.jqXHR[_], 
      /* u */ jqueryLib.JQueryNs.AjaxNs.ErrorTextStatus, 
      /* v */ java.lang.String, 
      /* repeated */ scala.Nothing, 
      (jqueryLib.JQueryNs.PromiseBase[ARF, AJF, ANF, BRF, BJF, BNF, CRF, CJF, CNF, RRF, RJF, RNF]) | jqueryLib.JQueryNs.Thenable[ARF] | ARF
    ]
  ): jqueryLib.JQueryNs.PromiseBase[ARF, AJF, ANF, BRF, BJF, BNF, CRF, CJF, CNF, RRF, RJF, RNF] = js.native
  // #endregion
  /**
  ...
  ```
    */
  @JSName("catch")
  def catch_ARFAJFANFBRFBJFBNFCRFCJFCNFRRFRJFRNFPromiseBase[ARF, AJF, ANF, BRF, BJF, BNF, CRF, CJF, CNF, RRF, RJF, RNF](): jqueryLib.JQueryNs.PromiseBase[ARF, AJF, ANF, BRF, BJF, BNF, CRF, CJF, CNF, RRF, RJF, RNF] = js.native
  /**
  ...
  ```
    */
  def done(
    doneCallback: jqueryLib.JQueryNs.TypeOrArray[
      jqueryLib.JQueryNs.DeferredNs.CallbackBase[
        _, 
    ...
    doneCallbacks: (jqueryLib.JQueryNs.TypeOrArray[
      jqueryLib.JQueryNs.DeferredNs.CallbackBase[
        _, 
        jqueryLib.JQueryNs.AjaxNs.SuccessTextStatus, 
        jqueryLib.JQueryNs.jqXHR[_], 
  ...
  ```
    */
  def fail(
    failCallback: jqueryLib.JQueryNs.TypeOrArray[
      jqueryLib.JQueryNs.DeferredNs.CallbackBase[
        jqueryLib.JQueryNs.jqXHR[_], 
    ...
    failCallbacks: (jqueryLib.JQueryNs.TypeOrArray[
      jqueryLib.JQueryNs.DeferredNs.CallbackBase[
        jqueryLib.JQueryNs.jqXHR[_], 
        jqueryLib.JQueryNs.AjaxNs.ErrorTextStatus, 
        java.lang.String, 
  ...
  ```
    */
  def pipe[ARP, AJP, ANP, BRP, BJP, BNP, CRP, CJP, CNP, RRP, RJP, RNP](): jqueryLib.JQueryNs.PromiseBase[ARP, AJP, ANP, BRP, BJP, BNP, CRP, CJP, CNP, RRP, RJP, RNP] = js.native
  /**
    * Utility method to filter and/or chain Deferreds.
    * @param doneFilter An optional function that is called when the Deferred is resolved.
    * @param failFilter An optional function that is called when the Deferred is rejected.
  ...
  def pipe[ARD, AJD, AND, BRD, BJD, BND, CRD, CJD, CND, RRD, RJD, RND](
    doneFilter: js.Function4[
      /* t */ js.Any, 
      /* u */ jqueryLib.JQueryNs.AjaxNs.SuccessTextStatus, 
      /* v */ jqueryLib.JQueryNs.jqXHR[_], 
      /* repeated */ scala.Nothing, 
      (jqueryLib.JQueryNs.PromiseBase[ARD, AJD, AND, BRD, BJD, BND, CRD, CJD, CND, RRD, RJD, RND]) | jqueryLib.JQueryNs.Thenable[ARD] | ARD
    ]
  ): jqueryLib.JQueryNs.PromiseBase[ARD, AJD, AND, BRD, BJD, BND, CRD, CJD, CND, RRD, RJD, RND] = js.native
  /**
    * Utility method to filter and/or chain Deferreds.
    * @param doneFilter An optional function that is called when the Deferred is resolved.
    * @param failFilter An optional function that is called when the Deferred is rejected.
  ...
  def pipe[ARF, AJF, ANF, BRF, BJF, BNF, CRF, CJF, CNF, RRF, RJF, RNF](
    ...
    failFilter: js.Function4[
      ...
      /* v */ java.lang.String, 
      /* repeated */ scala.Nothing, 
      (jqueryLib.JQueryNs.PromiseBase[ARF, AJF, ANF, BRF, BJF, BNF, CRF, CJF, CNF, RRF, RJF, RNF]) | jqueryLib.JQueryNs.Thenable[AJF] | AJF
    ]
  ): jqueryLib.JQueryNs.PromiseBase[ARF, AJF, ANF, BRF, BJF, BNF, CRF, CJF, CNF, RRF, RJF, RNF] = js.native
  def pipe[ARP, AJP, ANP, BRP, BJP, BNP, CRP, CJP, CNP, RRP, RJP, RNP](
    ...
    progressFilter: js.Function4[
      ...
      /* v */ scala.Nothing, 
      /* repeated */ scala.Nothing, 
      (jqueryLib.JQueryNs.PromiseBase[ARP, AJP, ANP, BRP, BJP, BNP, CRP, CJP, CNP, RRP, RJP, RNP]) | jqueryLib.JQueryNs.Thenable[ANP] | ANP
    ]
  ): jqueryLib.JQueryNs.PromiseBase[ARP, AJP, ANP, BRP, BJP, BNP, CRP, CJP, CNP, RRP, RJP, RNP] = js.native
  /**
    * Utility method to filter and/or chain Deferreds.
    * @param doneFilter An optional function that is called when the Deferred is resolved.
    * @param failFilter An optional function that is called when the Deferred is rejected.
  ...
  ): jqueryLib.JQueryNs.PromiseBase[
    ARD | ARF, 
    AJD | AJF, 
    AND | ANF, 
    BRD | BRF, 
  ...
  /**
    ...
    */
  def progress(
    progressCallback: jqueryLib.JQueryNs.TypeOrArray[
      jqueryLib.JQueryNs.DeferredNs.CallbackBase[scala.Nothing, scala.Nothing, scala.Nothing, scala.Nothing]
    ],
    progressCallbacks: (jqueryLib.JQueryNs.TypeOrArray[
      jqueryLib.JQueryNs.DeferredNs.CallbackBase[scala.Nothing, scala.Nothing, scala.Nothing, scala.Nothing]
    ])*
  ): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def `then`[TResult1, TResult2](): jqueryLib.JQueryNs._Promise[TResult1 | TResult2] = js.native
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ js.Any, TResult1 | js.Thenable[TResult1]]): jqueryLib.JQueryNs._Promise[TResult1 | TResult2] = js.native
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ js.Any, TResult1 | js.Thenable[TResult1]],
    onrejected: js.Function1[/* reason */ js.Any, TResult2 | js.Thenable[TResult2]]
  ): jqueryLib.JQueryNs._Promise[TResult1 | TResult2] = js.native
  def `then`[TResult1, TResult2](
  ...
  ```
    */
  @JSName("then")
  def then_ARPAJPANPBRPBJPBNPCRPCJPCNPRRPRJPRNPPromiseBase[ARP, AJP, ANP, BRP, BJP, BNP, CRP, CJP, CNP, RRP, RJP, RNP](): jqueryLib.JQueryNs.PromiseBase[ARP, AJP, ANP, BRP, BJP, BNP, CRP, CJP, CNP, RRP, RJP, RNP] = js.native
  /**
    * Attaches callbacks for the resolution and/or rejection of the Promise.
    * @param onfulfilled The callback to execute when the Promise is resolved.
    * @param onrejected The callback to execute when the Promise is rejected.
